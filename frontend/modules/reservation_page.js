...
//   loadJSON(config.backendEndpoint+"/reservations/",myData,'jsonp');
...
// }
async function fetchReservations() {
  // TODO: MODULE_RESERVATIONS  // 1. Fetch Reservations by invoking the REST API and return them  
  try
  ...
  {let response = await fetch(config.backendEndpoint + "/reservations/");
    ...
    return data;
     ...
     return null;
   }// Place holder for functionality to work in the Stubs  return null;}
